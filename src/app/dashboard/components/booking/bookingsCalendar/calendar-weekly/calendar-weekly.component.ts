...
export class CalendarWeeklyComponent implements OnInit, OnDestroy {
  ...
  getStaticBookings(){
    ...
    booking1.service = new Service();
    booking1.service.serviceName = 'Haircut and Styling';
    booking1.service.color = '#5d77a2';
    ...
    booking2.service = new Service();
    booking2.service.serviceName = 'Keratin Treatment';
    booking2.service.color = '#6bbe60';
    ...
    booking3.service = new Service();
    booking3.service.serviceName = 'Bridal and Event Hair Styling';
    booking3.service.color = '#c44f4f';
