...
export class TopbarComponent {
  ...
  routes: Navigation[] = [
    ...
    { name: 'usuarios',                      icon: 'panel',    route: '/users',                module: "users",                active: false },
    { name: 'servicios',                     icon: 'panel',    route: '/services',             module: "services",             active: false },
    { name: 'estilistas',                    icon: 'panel',    route: '/suppliers',            module: "suppliers",            active: false },
    { name: 'categorías',                    icon: 'panel',    route: '/categories',           module: "categories",           active: false },
    { name: 'compañías',                      icon: 'panel',    route: '/companies',            module: "companies",            active: false },
    { name: 'Recevas',                      icon: 'panel',    route: '/bookings',            module: "bookings",            active: false },
  ];
