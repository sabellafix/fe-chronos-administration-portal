...
export class ServicesListComponent {
  titleComponent : string = "Listado de servicios";
  loading: boolean = false;
  service: Service = new Service();
  services: Service[] = [];
   
  attributes : Option[] = [ 
    {name: "Nombre", code : "serviceName"}, 
    {name: "Proveedor", code : "providerId"},
    {name: "Categoría", code : "categoryId"},
    {name: "Precio", code : "price"},
    {name: "Moneda", code : "currency"} 
  ];
